...
arcade::SDLModule::SDLModule() : arcade::ADisplayModule("SDL"), _renderer(), _window(), _status(
    true), _textures(), _sprites(), _shapes()
{}
...
// void arcade::SDLModule::draw(std::vector<std::shared_ptr<IDrawable>> drawable,
//     std::pair<int, int> position, [[maybe_unused]] std::string &name
// )
// {
